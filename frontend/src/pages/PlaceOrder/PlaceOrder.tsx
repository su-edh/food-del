...
const PlaceOrder = () => {
  ...
  return (
    <form onSubmit={placeOrder} className="place-order flex items-start justify-between gap-12 mt-24">
      ...
      <div className="cart-total flex-1 flex-col gap-5">
          ...
          <button type="submit" className="border-none text-white py-3 px-0 rounded cursor-pointer">
